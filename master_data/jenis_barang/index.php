...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'create') {
        if ($kode && $nama) {
            ...
            $stmt->bind_param('ss',$kode,$nama); $stmt->execute(); $stmt->close();
        ...
        $stmt->bind_param('ssi',$kode,$nama,$id); $stmt->execute(); $stmt->close();
        ...
        <div class="card">
          ...
          <div class="table-wrapper">
            <table class="table" id="jenisTable">
              <thead><tr><th>#</th><th>Kode</th><th>Nama Jenis</th><th>Jml Barang</th><th>Aksi</th></tr></thead>
              <tbody>
