        ...
        <table class="table table-bordered table-sm" style="font-size:.82rem">
          <thead>
            <tr class="table-info text-center">
              <th>No</th><th>Tanggal</th><th>Kode Barang</th><th>Nama Barang</th><th>Satuan</th>
              <th>Stok Sistem</th><th>Stok Fisik</th>
              <th>Selisih</th><th>Status</th>
            </tr>
          </thead>
          <tbody>
            <?php $no=1; $found=false; $totalSelisih=0; while($r=$data->fetch_assoc()): $found=true; $totalSelisih+=$r['selisih']; ?>
            <tr>
            ...
            <tr><td colspan="9" class="text-center text-muted py-4">Tidak ada data stock opname.</td></tr>
            <?php endif; ?>
          </tbody>
          <?php if($found): ?>
